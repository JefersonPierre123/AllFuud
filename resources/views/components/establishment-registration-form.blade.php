    ...
    <form action="#" class="container mt-4">
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="Nome da Franquia" required>
            </div>
            <div class="col-md-6">
                <label for="unit_name" class="form-label">Nome da Unidade</label>
                <input type="text" name="unit_name" id="unit_name" class="form-control" placeholder="Nome da Unidade" required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="phone" id="phone" class="form-control" placeholder="(00) 00000-0000" required>
            </div>
            <div class="col-md-6">
                <label for="contact_email" class="form-label">Email para Contato</label>
                <input type="email" name="contact_email" id="contact_email" class="form-control" placeholder="email@exemplo.com" required>
            </div>
        </div>
